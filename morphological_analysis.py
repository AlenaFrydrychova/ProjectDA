...
i = 3900 #musí se rovnat začátku rozsahu ve for cyklu níže (nelekat se, nebude se to rovnat tomu jaké id je v souboru lemmata.csv naposledy)
for text in all_reviews_after_splitting[3900:4400]:
